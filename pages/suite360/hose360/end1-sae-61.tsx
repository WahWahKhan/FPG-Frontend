/**
 * HOSE360 Step 4 — End 1 SAE Code 61 fitting shape+size picker
 */
...
function End1Sae61Inner({ options }: { options: Hose360Options }) {
    ...
    <Hose360Layout currentStep={4} totalSteps={11} showPriceBar={false}>
      <SAEFittingPicker
        ...
        onPicked={(shape, size, price) => {
          setEnd1Fitting(shape, size, price, 'end1-sae-61');
...
export default function End1Sae61() {
  return <Hose360OptionsGate>{(options) => <End1Sae61Inner options={options} />}</Hose360OptionsGate>;
}
