/**
 * HOSE360 Step 6 — End 2 SAE Code 61 fitting shape+size picker.
...
function End2Sae61Inner({ options }: { options: Hose360Options }) {
...
export default function End2Sae61() {
  return <Hose360OptionsGate>{(options) => <End2Sae61Inner options={options} />}</Hose360OptionsGate>;
}
