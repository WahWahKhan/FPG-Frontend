...
export default function Start() {
  ...
  // Clear Tube360 context when user lands on start page
  useEffect(() => {
    console.log('🧹 [TUBE360] Clearing context - user starting fresh');
    resetConfig();

    // Clear any session flags
    if (typeof window !== 'undefined') {
      sessionStorage.removeItem('tube360-quote-result');
    }
  }, [resetConfig]);

  const handleGetStarted = () => {
    router.push('/suite360/tube360/method');
  };
  ...
  return (
    ...
    <Head>
      ...
      <meta name="description" content="Order custom CNC-bent hydraulic steel tubes online. Choose carbon or stainless, metric or imperial, flared or cutting-ring ends and enter your bends for an instant price - or upload your drawing for a quote." />
    </Head>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center space-y-4">
            ...
            <p
              ...
              style={{ color: '#6b7280' }}
            >
              Build custom CNC-bent hydraulic tubes. Choose carbon or stainless steel, imperial or metric sizes, flared or cutting-ring ends, and enter your bend schedule for an instant price - or upload your own drawing and we&apos;ll email you a quote.
            </p>
          </motion.div>
